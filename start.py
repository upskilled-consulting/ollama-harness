...
SERVICES: dict[str, str] = {
    ...
    "llama":     r"llama.cpp\build\bin\llama-server.exe"
                 ...
                 r" --ctx-size 16384 --parallel 2 --port 8083 -ngl 99 --reasoning-budget -1",
    "llama8b":   r"llama.cpp\build\bin\llama-server.exe"
                 r" --model models\qwen3-8b.gguf"
                 r" --ctx-size 16384 --parallel 4 --port 8082 -ngl 99 --reasoning-budget 1024",
}

PORT_MAP = {"api": 7860, "mcp": 8766, "dashboard": 5173, "ollama": 11434, "llama": 8083, "llama8b": 8082}
